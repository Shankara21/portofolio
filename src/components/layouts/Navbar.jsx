...
const Navbar = () => {
  ...
  return (
    <div className={`navbar lg:px-8 py-4 fixed z-50 fade-down-animation duration-500  ${isScrolled && 'bg-slate-100 dark:bg-slate-800 shadow-xl'}`}>
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow  rounded-box w-52 bg-slate-50 dark:bg-slate-600 dark:text-slate-50">
        ...
        <div className="flex-col">
          ...
          {/* <p className='text-3xl font-poppins text-yellow-500 font-bold tracking-[10px]'>{currentTime.toLocaleTimeString()}</p> */}
        </div>
      </div>
